...
@if (!empty($products))
    <section id="{{ $section_id ?? 'section-products-carousel' }}" class="section bg-surface overflow-hidden"
        data-products-carousel aria-roledescription="{{ __('carosello', 'sage') }}"
            ...
            <div class="swiper js-products-swiper">
                <div class="swiper-wrapper" aria-live="polite">
                    @foreach ($products as $product)
                        <div class="swiper-slide" role="group" aria-roledescription="{{ __('slide', 'sage') }}"
