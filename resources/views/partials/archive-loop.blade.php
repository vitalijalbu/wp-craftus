      ...
      <div class="mt-14 flex justify-center">
        <nav aria-label="{{ __('Navigazione archivio', 'sage') }}">
          {!! get_the_posts_pagination([
            'mid_size'  => 2,
            'prev_text' => '<svg class="size-4" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24" aria-hidden="true"><path stroke-linecap="round" stroke-linejoin="round" d="M15.75 19.5 8.25 12l7.5-7.5"/></svg><span class="sr-only">' . __('Precedente', 'sage') . '</span>',
            'next_text' => '<span class="sr-only">' . __('Successivo', 'sage') . '</span><svg class="size-4" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24" aria-hidden="true"><path stroke-linecap="round" stroke-linejoin="round" d="m8.25 4.5 7.5 7.5-7.5 7.5"/></svg>',
