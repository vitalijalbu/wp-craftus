    ...
    <div class="flex flex-col sm:flex-row min-h-[320px]">
      ...
      <div class="sm:w-2/5 bg-ink flex items-center justify-center p-8 relative overflow-hidden">
        <div class="absolute inset-0 opacity-5">
          ...
          <div class="absolute -bottom-10 -right-10 w-32 h-32 bg-gold rounded-full"></div>
        </div>
        <div class="relative text-center">
          <p class="font-sans text-xs font-semibold tracking-[0.3em] uppercase text-gold mb-4">{{ __('Esclusivo', 'sage') }}</p>
