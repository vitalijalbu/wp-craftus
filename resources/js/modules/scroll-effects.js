...
const EFFECTS = {
  'slide-up': (el) => gsap.fromTo(el,
    { opacity: 0, y: 64 },
    { opacity: 1, y: 0, duration: 0.9, ease: 'power3.out',
      scrollTrigger: { trigger: el, start: 'top 88%', once: true } }
  ),

  'slide-down': (el) => gsap.fromTo(el,
    { opacity: 0, y: -64 },
    { opacity: 1, y: 0, duration: 0.9, ease: 'power3.out',
      scrollTrigger: { trigger: el, start: 'top 88%', once: true } }
  ),

  'slide-left': (el) => gsap.fromTo(el,
    { opacity: 0, x: 80 },
    { opacity: 1, x: 0, duration: 0.9, ease: 'power3.out',
      scrollTrigger: { trigger: el, start: 'top 88%', once: true } }
  ),

  'slide-right': (el) => gsap.fromTo(el,
    { opacity: 0, x: -80 },
    { opacity: 1, x: 0, duration: 0.9, ease: 'power3.out',
      scrollTrigger: { trigger: el, start: 'top 88%', once: true } }
  ),

  'fade': (el) => gsap.fromTo(el,
    { opacity: 0 },
    { opacity: 1, duration: 1.2, ease: 'power2.out',
      scrollTrigger: { trigger: el, start: 'top 85%', once: true } }
  ),

  'zoom-in': (el) => gsap.fromTo(el,
    { opacity: 0, scale: 0.88 },
    { opacity: 1, scale: 1, duration: 0.9, ease: 'power3.out',
      scrollTrigger: { trigger: el, start: 'top 88%', once: true } }
  ),

  'text-reveal': (el) => gsap.fromTo(el,
    { opacity: 0, y: 80, skewY: 2 },
    { opacity: 1, y: 0, skewY: 0, duration: 1.1, ease: 'power4.out',
      scrollTrigger: { trigger: el, start: 'top 90%', once: true } }
  ),

  'line-in': (el) => gsap.fromTo(el,
  ...
  'anim-image-parallax': (el) => gsap.fromTo(el,
